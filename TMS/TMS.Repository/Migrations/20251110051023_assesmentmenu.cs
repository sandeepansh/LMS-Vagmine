...
{
    public partial class assesmentmenu : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[] { 13, "Index", "", "FacultyQuizAssessment", null, false, "fas fa-discourse", true, 1, "Quiz Assessment", 15 });

            migrationBuilder.InsertData(
                table: "RolePermissions",
                columns: new[] { "FormId", "RoleId", "Add", "Edit", "View" },
                values: new object[] { 13, 1, true, true, true });
        }
